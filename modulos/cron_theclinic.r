...
# enlaces <- c(paste0("https://www.theclinic.cl/lo-ultimo/page/", 2001:3000)); hist = "_h_a"
# enlaces <- c(paste0("https://www.theclinic.cl/lo-ultimo/page/", 3001:4000)); hist = "_h_b"
# enlaces <- c(paste0("https://www.theclinic.cl/lo-ultimo/page/", 4001:5000)); hist = "_h_c"
